          ...
          <form onSubmit={handleSubmit}>
           <label className="area">
             ...
             <div className="area--input">
               <input type="text" required disabled={disabled} value={title} onChange={e=>setTitle(e.target.value)}/>
             </div>
           </label>
           <label className="area">
           ...
           <label className="area">
             ...
             <div className="area--input">
               <MaskedInput mask={priceMask} placeholder="R$ " disabled={disabled ||priceNegotiable}
           ...
           <label className="area">
             <div className="area--title">Imagems 1 ou mais</div>
             <div className="area--input">
